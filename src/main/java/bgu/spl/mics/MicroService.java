...
public abstract class MicroService implements Runnable {
    ...
    private Map<Class<? extends Message>, Callback<? extends Message>> callbackMap;
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                if(msg.getClass() == PublishTerminateBroadcast.class)
                    Thread.currentThread().interrupt();
                Callback callback = callbackMap.get(msg.getClass());
                callback.call(msg);
            } catch (InterruptedException e) {
                this.msgBus.unregister(this);
                terminate();
            }
        }
    }
